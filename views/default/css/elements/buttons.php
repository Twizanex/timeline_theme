...
.elgg-button-action {
	background: #5c8c4f url(<?php echo elgg_get_site_url(); ?>mod/timeline_theme/graphics/button_back.png) repeat-x left top;
	border:1px solid #5c8c4f;
	color: #fff;
	padding: 2px 15px;
	text-align: center;
	font-weight: bold;
...
.elgg-button-action:focus {
	background: #5c8c4f url(<?php echo elgg_get_site_url(); ?>mod/timeline_theme/graphics/button_back.png) repeat-x left bottom;
	color: #000;
	text-decoration: none;
	border: 1px solid #5c8c4f;
}
